...
def main(page: ft.Page):
    ...
    #     # trailing=ft.IconButton(icon=ft.icons.BRIGHTNESS_2_OUTLINED, on_click=lambda e: toggle_theme(page))
    # )
...
#         page.appbar.trailing = ft.IconButton(icon=ft.icons.DARK_MODE_OUTLINED, on_click=lambda e: toggle_theme(page))
        
#     else:
#         page.theme_mode = ft.ThemeMode.LIGHT
#         page.appbar.trailing = ft.IconButton(icon=ft.icons.BRIGHTNESS_5, on_click=lambda e: toggle_theme(page))
